...
namespace eos
{
        ...
        e_q(-1.0/3.0)
    {
        ...
        std::string formfactor = o.get("formfactor", "CFFMPSV2015-cartesian");
        nonlocal_formfactor = NonlocalFormFactor::make(formfactor, p, o);
        if (! nonlocal_formfactor)
        {
            throw InvalidOptionValueError("formfactor", formfactor, "CFFMPSV2015-cartesian, CFFMPSV2015-polar, BCvD2016-model1-cartesian, BCvD2016-model1-polar");
        }
    ...
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::amplitudes(const double & s) const
    {
        ...
        complex<double> h_0 = nonlocal_formfactor->h_long(s);
        complex<double> h_p = nonlocal_formfactor->h_plus(s);
        complex<double> h_m = nonlocal_formfactor->h_minus(s);
