...
namespace eos
{
    ...
    struct Implementation<LambdabToLambdaCharmonium>
    {
        ...
        NonlocalFormFactorPtr<nff::OneHalfPlusToOneHalfPlus> nonlocal_formfactor;
        ...
        Implementation(const Parameters & p, const Options & o, ParameterUser & u) :
            ...
            nonlocal_formfactor(NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::make("Lambda_b->Lambda::" + opt_formfactor.value(), p, o)),
...

        {
            ...
            if ("J/psi" == psi.value())
            {
                ...
                residue_H_V_perp = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_V_perp_residue_jpsi, nonlocal_formfactor);
                residue_H_V_long = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_V_long_residue_jpsi, nonlocal_formfactor);

                residue_H_A_perp = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_A_perp_residue_jpsi, nonlocal_formfactor);
                residue_H_A_long = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_A_long_residue_jpsi, nonlocal_formfactor);
            }
            else
            {
                residue_H_V_perp = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_V_perp_residue_psi2s, nonlocal_formfactor);
                residue_H_V_long = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_V_long_residue_psi2s, nonlocal_formfactor);

                residue_H_A_perp = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_A_perp_residue_psi2s, nonlocal_formfactor);
                residue_H_A_long = std::bind(&NonlocalFormFactor<nff::OneHalfPlusToOneHalfPlus>::H_A_long_residue_psi2s, nonlocal_formfactor);
            }
